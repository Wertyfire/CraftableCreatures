/**
 * File created on 12:03 05.09.2026 by Wertyfire
 */
...
public class TileEntitySoulExtractor extends TileEntity implements IInventory, ISidedInventory {
    ...
    public String getInvName() {
        return "container.soulExtractor";
    }
                ...
                if (fuelWorkTime == 0 && canExtractSoul()) {
                    ...
                    if (fuelWorkTime > 0) {
                        ...
                        if (soulExtractorItemStacks[1] != null) {
                            if (soulExtractorItemStacks[1].getItem().func_46056_k())
                                soulExtractorItemStacks[1] = new ItemStack(soulExtractorItemStacks[1].getItem().setFull3D());
                            else
    ...
    public void extractSoul() {
        if (canExtractSoul()) {
            ...
            else if (soulExtractorItemStacks[3].isItemEqual(stack)) soulExtractorItemStacks[3].stackSize +=
                    stack.stackSize;
