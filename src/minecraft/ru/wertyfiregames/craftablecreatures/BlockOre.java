/**
 * File created on 23:09 04.09.2026 by Wertyfire
 */
...
public class BlockOre extends BlockDefault {
    public BlockOre(int id, int textureIndex, float hardness, float resistance) {
        super(id, textureIndex, Material.rock, hardness, resistance, soundStoneFootstep);
    }
