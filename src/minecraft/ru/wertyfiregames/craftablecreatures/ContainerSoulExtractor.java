/**
 * File created on 12:49 05.09.2026 by Wertyfire
 */
...
public class ContainerSoulExtractor extends Container {
    ...
    public void updateProgressBar(int id, int value) {
        if (id == 0) soulExtractor.extractTime = value;
        if (id == 1) soulExtractor.fuelWorkTime = value;
        if (id == 2) soulExtractor.currentFuelWorkTime = value;
    }
