/**
 * File created on 13:00 05.09.2026 by Wertyfire
 */
...
public class GuiSoulExtractor extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer() {
        fontRenderer.drawString(StringTranslate.getInstance().translateKey("container.soulExtractor"), 60, 6, 4210752);
        fontRenderer.drawString(StringTranslate.getInstance().translateKey("container.inventory"), 8, ySize - 96 + 2, 4210752);
    }
