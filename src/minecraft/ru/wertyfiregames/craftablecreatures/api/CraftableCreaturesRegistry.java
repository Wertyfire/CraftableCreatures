...
public class CraftableCreaturesRegistry {
     ...
     * Uses {@link net.minecraft.src.EntityList#createEntityByName(String, World)}
     * @param modId ID of target mod
    ...
    public static int getEntityIdSafe(String modId, String entityId) {
        if (!modLoaded(modId)) {
            ...
            try {
                Entity entity = EntityList.createEntityByName(entityId, null);
    ...
    /**Get modified item from se fuel handler. Used by {@linkplain ru.wertyfiregames.craftablecreatures.TileEntitySoulExtractor#getFuelWorkTime(ItemStack) TileEntitySoulExtractor#getFuelWorkTime(ItemStack)}
    ...
    /**Trigger soul extracted event. Used by {@linkplain ru.wertyfiregames.craftablecreatures.SlotSoulExtractor#onPickupFromSlot(ItemStack)} (ItemStack) SlotSoulExtractor#onPickupFromSlot(ItemStack)}
    ...
    /**Trigger item combined event. Used by {@linkplain ru.wertyfiregames.craftablecreatures.SlotCombiner#onPickupFromSlot(ItemStack) SlotCombiner#onPickupFromSlot(ItemStack)}
