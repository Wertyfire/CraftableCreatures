/**
 * File created on 20:28 11.09.2026 by Wertyfire
 */
...
public class GuiScreenGuideBook extends GuiScreen {
    ...
    public void initGui() {
        ...
        wasUnicode = StringTranslate.getInstance().isUnicode();
    ...
    private void drawPageText(int mouseX, int mouseY) {
        ...
        if (currentPage == 2) {
            ...
            int stackY = lineYPos;
            int stacks = 0;
            for (int i = 0; i < ItemSoulElement.soulTextures.length; i++) {
            ...
            drawItemStack(s(mod_CraftableCreatures.ocelotTail), lineXPos + xSize - 18 - 32, lineYPos - fontHeight * 2);
            ...
            drawCombiningRecipe(s(mod_CraftableCreatures.soulElement, 1, 1), s(mod_CraftableCreatures.spawnEggTemplate), s(Item.monsterPlacer, 1, EntityList.getEntityID(new EntityCreeper(null))), lineXPos + 9, lineYPos);
        }
    }
