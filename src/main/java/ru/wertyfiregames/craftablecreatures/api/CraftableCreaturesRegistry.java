...
public class CraftableCreaturesRegistry {
    ...
    /**Get modified item from se fuel handler. Used by {@linkplain TileEntitySoulExtractor#getFuelWorkTime(ItemStack) TileEntitySoulExtractor#getFuelWorkTime(ItemStack)}
