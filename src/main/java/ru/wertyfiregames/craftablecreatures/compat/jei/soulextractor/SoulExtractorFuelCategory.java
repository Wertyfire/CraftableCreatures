...
public class SoulExtractorFuelCategory extends SoulExtractorRecipeCategory<SEFuelRecipe> {
    @Nonnull
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull SEFuelRecipe recipeWrapper) {
