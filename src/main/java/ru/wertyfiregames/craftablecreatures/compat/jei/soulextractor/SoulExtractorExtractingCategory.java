...
public class SoulExtractorExtractingCategory extends SoulExtractorRecipeCategory<SERecipe> {
    @Nonnull
    ...
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull SERecipe recipeWrapper) {
