...
public class CombiningRecipeMaker {
    @Nonnull
    public static List<CombiningRecipe> getCombinerRecipes(IJeiHelpers helpers) {
        ...
        List<CombiningRecipe> recipes = new ArrayList<>();
        ...
        for (Map.Entry<Pair<ItemStack, ItemStack>, ItemStack> entry : combiningMap.entrySet()) {
            ...
            CombiningRecipe recipe = new CombiningRecipe(firstInputs, secondInputs, output, experience);
            recipes.add(recipe);
        }
