...
public class CombiningRecipe extends BlankRecipeWrapper {
    @Nonnull
    ...
    public CombiningRecipe(@Nonnull List<ItemStack> input, @Nonnull List<ItemStack> secInput, @Nonnull ItemStack output, float experience) {
